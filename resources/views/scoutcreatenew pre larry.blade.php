...
<div class="row justify-content-end mt-5">
    <div class="col-lg-3 d-none" id="shortcutS">
        </br><h3>Score: <span style="border: solid 1px black; max-width: fit-content; padding: 5px;" id="tScore">00</span></h3>
    </div>
    <div class="col-lg-6">
        <h1 class="text-center">Scout</h1>
    </div>
    <div class="col-lg-3">
...
{{-- <div id="ajaxsuccess" class="row d-none">
  <div class="col">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="margin-left:2.5%;margin-top:1.5%;">
      <li class="nav-item">
        ...
        <div class="tab-pane @if(session('inputtype') == "field" && !$errors->any()) show active @endif" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
          <div class="row">
              <ul id="modeselect" class="nav nav-pills mb-3" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true"><span id="switchview">Switch View</span></a>
                  </li>
                  <label class="switch">
              ...
              <input min="0" type="number" id="matchnum" placeholder="Match Number" name="fname">
              <div id="teamnumberdiv">
              <input min="0" type="number" id="teamnum" placeholder="(enter match num first)" name="lname" disabled>
              </div>
          </div>
                       ...
                       <div class="col-9">
                            ...
                            <div class="popup" id="popup26">
                                <div class="input-group">
                                    <input type="text" class="form-control mb-2 mr-sm-2 popupinput" id="autobluetop" placeholder="Top">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control mb-2 mr-sm-2 popupinput" id="autobluebottom" placeholder="Bot">
                                    <div class="input-group-append" id="button-addon4">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control mb-2 mr-sm-2 popupinput" id="autoblueinner" placeholder="Inn">
                                    <div class="input-group-append" id="button-addon4">
                      ...
                      <div class="col-9">
                          <!--Tele-Op Field Form-->
                              ...
                              <div class="popup" id="popup9">
                                 <div class="input-group">
                                     <input type="text" class="form-control mb-2 mr-sm-2 popupinput" id="telebluetop" placeholder="Top">
                                    <div class="input-group-append" id="button-addon4">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control mb-2 mr-sm-2 popupinput" id="telebluebottom" placeholder="Bot">
                                    <div class="input-group-append" id="button-addon4">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control mb-2 mr-sm-2 popupinput" id="teleblueinner" placeholder="Inn">
                                    <div class="input-group-append" id="button-addon4">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control mb-2 mr-sm-2 popupinput" id="telebluemissed" placeholder="Miss">
                                    <div class="input-group-append" id="button-addon4">
            ...
            <div class="container">
                <form method="POST" action="{{ route('scout.store') }}" id="scoutform">
                    ...
                    <div class="alert alert-warning mt-4" role="alert">
                      NOTICE: Only the data in this form will be submitted. If you need to make any changes, do it in this form!
                    </div>
