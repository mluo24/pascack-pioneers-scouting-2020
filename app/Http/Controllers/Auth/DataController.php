...
class DataController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'mode' => 'required',
            'rocketPanels' => 'required|digits_between:0,3|integer',
            'rocketCargo' => 'required|digits_between:0,3|integer',
            'cargoShipPanels' => 'required|digits_between:0,3|integer',
            'cargoShipCargo' => 'required|digits_between:0,3|integer',
            'hab' => 'required',
        ...
        $data->competition_id = $request->session()->get('competition');
        ...
        $data->rocket_hatches = $request->input('rocketPanels');
        $data->rocket_balls = $request->input('rocketCargo');
        $data->cargo_hatches = $request->input('cargoShipPanels');
        $data->cargo_balls = $request->input('cargoShipCargo');
    ...
    {
        //match layout
        $data = Data::orderBy('match_num', 'asc')->get();
