...
class HomeController extends Controller
{
    ...
    public function changeCompetition(Request $request) {
        $competitions = DB::table('competitions')->get();
        $request->session()->put('competition' , $request->input('competition'));
        return redirect()->route('home', compact('competitions'))->with('success', 'Competition session changed successfully');
    }
    ...
    public function update(Request $request, $id) 
    {
        ...
        $user = User::find($id);
        return redirect()->route('userpage', compact('user'))->with('success', 'Updated successfully');
    }
